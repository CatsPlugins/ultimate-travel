...
if( !class_exists('cats_acf_field_tourdata') ) :


class cats_acf_field_tourdata extends acf_field {
	...
	*/
	...
	function __construct( $settings ) {
		...
		*/
		...
		$this->label = __('Tour Data', 'ultimate-travel');
	...
	*/
	...
	function render_field( $field ) {
        ...
        include dirname(UTT_PATH) . '/tour/views/admin_meta_box.php';
	}
...
// initialize
new cats_acf_field_tourdata( $this->settings );
